...
/**
 * OrderRecordSearch represents the model behind the search form about `backend\models\OrderRecord`.
 */
class OrderRecordSearch extends OrderRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'customerid', 'name', 'description', 'created_at', 'updated_at', 'assigned_user', 'created_by', 'updated_by', 'approved_by', 'order_id', 'order_detail_order_id', 'order_detail_order_product_id', 'order_detail_order_id1', 'order_detail_order_product_id1'], 'safe'],
